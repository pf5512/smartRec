...
import com.thousandsunny.thirdparty.easemob.comm.invoker.HttpClientRestAPIInvoker;
import com.thousandsunny.thirdparty.easemob.comm.invoker.JerseyRestAPIInvoker;
...
public class EasemobRestAPIFactory {
    ...
    private static final String BASE_PACKAGE = "com.thousandsunny.thirdparty.easemob.api.impl";
    ...
    public static EasemobRestAPIFactory getInstance(ClientContext context) {
        return new EasemobRestAPIFactory(context);
    }
